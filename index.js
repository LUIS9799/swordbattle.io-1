...
app.disable('x-powered-by'); //Disable Poweredby header to avoid vulnerability scanning against swordbattle.
...
if (production) {
	...
	const limiter = rateLimit({
		...
		message: "Too many requests from this IP, please try again" //Added a message when rate limit
	});
	app.use(limiter);
}
